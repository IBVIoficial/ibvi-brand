      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            ...
            IBVI, garantindo coerência multicanal, mensurabilidade (CTR +18%,
            CPL –10%, Brand Recall +25%, NPS 72, Precisão 95%) e conformidade de
            marca.
          </p>
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4">
            1. Introdução e Framework Estratégico
          </h2>
          ...
          <blockquote className="border-l-4 border-primary pl-6 italic text-lg text-muted-foreground mb-6">
            ...
            transparente e acionável, capacitando desde investidores individuais
            até grandes instituições."
            <br />
          ...
          <p className="text-muted-foreground mb-4">
            Definir padrões que traduzam a missão da IBVI: democratizar decisões
            imobiliárias com precisão de dados.
          </p>
          ...
          <p className="text-lg font-semibold text-center text-muted-foreground mb-8">
            <strong>Consistência</strong> • <strong>Integridade</strong> •{' '}
            <strong>Performance</strong> • <strong>Compliance</strong>
          </p>
          ...
          <ul className="list-disc pl-6 text-muted-foreground mb-6">
            <li>
              <strong>Precisão</strong>: Resultados baseados em dados confiáveis
              (95% acurácia)
            </li>
            <li>
          ...
          <p className="text-red-600 mb-8">
            <strong>❌ Proibições</strong>: Rotações, distorções, cores fora da
            paleta, efeitos extras, contraste &lt;4.5:1
          </p>

          <hr className="my-8" />

          <h2 className="text-2xl font-bold text-foreground mb-4">
            4. Especificações Cromáticas
          </h2>
          ...
          <p className="text-muted-foreground mb-8">
            <strong>QA Obrigatório</strong>: WCAG AA/AAA, Delta E &lt; 2,
            contraste ≥ 4.5:1
          </p>
  ...
  return animated ? (
    <motion.div whileHover={{ y: -2 }} transition={{ duration: 0.2 }}>
      {LogoSVG}
          ...
          <p className="text-muted-foreground mb-4">
            <strong>Comitê de Marca</strong>: Reuniões trimestrais para revisão
            e aprovação
          </p>
          ...
          <ul className="list-disc pl-6 text-muted-foreground mb-6">
            <li>
              ...
              <a
                href="https://brand.ibvi.com.br/downloads"
            ...
            <li>
              ...
              <a
                href="https://github.com/ibvi/brand"
                className="text-primary hover:underline"
              >
          ...
          <div className="bg-muted p-6 rounded-lg text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              <em>
                Este documento é propriedade intelectual da IBVI. Uso restrito a
